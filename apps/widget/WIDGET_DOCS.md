...
```html
<script 
  src="https://pub-a237803d9a4049e08f39776dcf74b747.r2.dev/widget.js" 
...
| `data-api-url` | No | Custom API URL (default: `https://api.vakkya.com`) |
...
1. Sign up at [vakkya.com](https://www.vakkya.com)
